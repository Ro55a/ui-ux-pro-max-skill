        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {NAV_LINKS.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-[13px] text-stone-500 hover:text-white transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            {COMPANY.linkedin && (
              <a
                ...
                className="inline-flex items-center gap-2 mt-5 text-[12px] text-stone-600 hover:text-white transition-colors"
              >
                LinkedIn
