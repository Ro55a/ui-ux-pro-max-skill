  ...
  return (
    <section className="relative py-20 overflow-hidden">
      <div
        ...
        style={{ background: "radial-gradient(ellipse 60% 60% at 50% 50%, rgba(208,201,188,0.03) 0%, transparent 70%)" }}
        aria-hidden
      />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-accent-600 mb-4">Why Catalyst</p>
